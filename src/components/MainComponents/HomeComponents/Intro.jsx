...
function Intro() {
  return (
    <div className=' md:h-[600px] h-[300px] w-[100%] md:top-[5rem] top-[2rem] homeImg flex items-start justify-center md:mb-[100px] mt-[40px] flex-col gap-[20px]'>
      <div className='text-gray-400 md:text-6xl text-[25px] md:w-[900px] w-[500px] h-auto max-h-[300px] relative md:px-[100px] px-[50px] leading-snug '>Write, Edit and Publish on BLOGEZZY  </div>
