...
function HomeMid() {
// const [windowWidth, isSmall] = useState(false)
// const 
// const checkit = (event) => {
//     console.log(window.innerWidth)
//     window.innerWidth < "570" ? isSmall(true):isSmall(false)
// }
    ...
    <div className='md:mb-[80px] mb-[40px] flex flex-col justify-center items-center md:gap-[30px] gap-[20px]'>
        {
            People.map( (person,index) => {
                return <div className={`w-full flex flex-row ${isSmall? "flex-col items-center":`flex-row items-center ${index%2==0?"justify-start":"justify-end"} md:px-[200px] px-[100px]`} gap-[15px]`} key={index}>
